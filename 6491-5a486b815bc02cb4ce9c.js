        ...
        76491: function(t, e, n) {
            ...
            var i = function(t, e) {
                ...
                c = function(t, e, n) {
                    var i;
                    return function() {
                        e.value >= 0 && (n || u.has(e) || "hidden" === document.visibilityState) && (e.delta = e.value - (i || 0), (e.delta || void 0 === i) && (i = e.value, t(e)))
                    }
                },
                s = function(t, e) {
                    var n, u = i("CLS", 0),
                ...
                m = function() {
                    return f < 0 && ((f = self.webVitals.firstHiddenTime) === 1 / 0 && d(), o((function() {
                        setTimeout((function() {
                ...
                v = function(t, e) {
                    var n, r = m(),
                        s = i("FCP"),
                        f = function(t) {
                            "first-contentful-paint" === t.name && (v && v.disconnect(), t.startTime < r.timeStamp && (s.value = t.startTime, s.entries.push(t), u.add(s), n()))
                        },
                        d = performance.getEntriesByName("first-contentful-paint")[0],
                        v = d ? null : a("paint", f);
                    (d || v) && (n = c(t, s, e), d && f(d), o((function(a) {
                        s = i("FCP"), n = c(t, s, e), requestAnimationFrame((function() {
                ...
                p = function(t, e) {
                    var n, s = m(),
                        f = i("FID"),
                        d = function(t) {
                            t.startTime < s.timeStamp && (f.value = t.processingStart - t.startTime, f.entries.push(t), u.add(f), n())
                        },
                        v = a("first-input", d);
                    n = c(t, f, e), v && r((function() {
                        v.takeRecords().map(d), v.disconnect()
                    }), !0), v || window.webVitals.firstInputPolyfill(d), o((function() {
                        f = i("FID"), n = c(t, f, e), window.webVitals.resetFirstInputPolyfill(), window.webVitals.firstInputPolyfill(d)
                    }))
                },
                l = function(t, e) {
                    var n, s = m(),
                    ...
                    if (v) {
                        ...
                        ["keydown", "click"].forEach((function(t) {
                            ...
                            f = i("LCP"), n = c(t, f, e), requestAnimationFrame((function() {
                                requestAnimationFrame((function() {
...
//# sourceMappingURL=6491-5a486b815bc02cb4ce9c.js.map